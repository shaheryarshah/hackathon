...
function SignUp() {
  ...
  return (
    <div className="flex flex-col container px-5 mx-auto sm:flex-row min-h-screen">
      {/* Left Section (Image) */}
      ...
      <div className="w-full sm:w-1/2 flex justify-center items-center bg-white p-6 sm:p-12">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="button"
              className="w-full gap-2 flex items-center justify-center px-6 py-2 border-2 border-gray-300 text-gray-600 font-semibold rounded-md mt-4 hover:bg-gray-100"
            >
              <FcGoogle />
              Sign Up with Google
            </button>
